...
intakes.forEach(i=>{
  ...
  const p = normPhone(i.ClientPhone || i.ClientId || '');
...
// match by email
const apptEmails = appointments.map(a=>normEmail(a.ClientEmail));
let apptsEmailMatches = 0;
let matchedIntakeIdsByEmail = new Set();
...
// quick sample of mismatches (first 5)
